...
@TeleOp(name="MaristBot: Teleop Tank V2", group="MaristBot")
//@Disabled
public class TeleopTank_Iterative_V2 extends OpMode {

    /* Declare OpMode members. */
    MaristBaseRobot robot       = new MaristBaseRobot(); // use the class created to define a Robot's hardware
    ...
    public void init() {
        ...
        armDeg = robot.armMotor.getCurrentPosition();
    ...
    public void loop() {
        ...
        */
        ...
        armDeg += 2*gamepad1.right_trigger;
        armDeg -= 2*gamepad1.left_trigger;
        robot.armMotor.setTargetPosition((int)armDeg);
        ...
        telemetry.addData("Arm Degrees", robot.armMotor.getCurrentPosition());
    }
